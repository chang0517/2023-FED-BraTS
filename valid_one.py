...
def main():
    ...
    valid_model = UNet3d(in_channels=4, n_classes=3, n_channels=24).to('cuda')
    ...
    model_name = f'fedadd_88'
    valid_model.load_state_dict(torch.load(f'model_save/{model_name}.pt',map_location = 'cuda'))
    valid_model.eval()
    ...
    fig.savefig(f"results_{model_name}.png", format="png",  pad_inches=0.2, transparent=False, bbox_inches='tight')
    fig.savefig(f"results_{model_name}.svg", format="svg",  pad_inches=0.2, transparent=False, bbox_inches='tight')
